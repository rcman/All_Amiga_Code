:: Set project folder
cd "C:\users\fgaetan\downloads\amiga\harddrive\blitz2\copyblock64\"
...
ConvertEOL unix copyblock64_win.bb2 copyblock64.bb2
...
WinUAEArexx blitzbasic2 1000 "dh0:BLITZ2/copyblock64/copyblock64.bb2"
