:: Set project folder
cd "C:\users\fgaetan\downloads\amiga\harddrive\blitz2\copyblockandsquare\"
...
ConvertEOL unix copyblockas_win.bb2 copyblockas.bb2
...
WinUAEArexx blitzbasic2 1000 "dh0:BLITZ2/copyblockandsquare/copyblockas.bb2"
