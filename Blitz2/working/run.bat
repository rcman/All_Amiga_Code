:: Set project folder
cd "C:\users\fgaetan\downloads\amiga\harddrive\blitz2\working\"
...
ConvertEOL unix working_win.bb2 working.bb2
...
WinUAEArexx blitzbasic2 1000 "dh0:BLITZ2/working/working.bb2"
