:: Set project folder
cd "C:\users\fgaetan\downloads\amiga\harddrive\blitz2\robostrip\"
...
ConvertEOL unix robostrip2_win.bb2 robostrip2_rx.bb2
...
WinUAEArexx blitzbasic2 1000 "dh0:BLITZ2/robostrip/robostrip2_rx.bb2"
