; Programmed By Franco Gaetan
; This Program opens a screen then takes slices from it and scrolls
; them off left then right off the screen.
...
run:
	...
	move.l	#0,a3
	move.l	#-5,a4
	move.w	#$15,a5 ; number of bytes to move (wide)	
       move.w  #70,d0
...
;       move.l  d0,a1
	...
	move.l	a5,a3
	cmp.l	#-5,a4		; is it going right?
	bne	set2		; if yes make it go left
	move.l	#5,a4
	bra	goahead

set2:	
	cmp.l	#5,a4		; is it going left?
	bne	goahead		; make it go right!
	move.l	#-5,a4

goahead:


	move.w	#70,d0		; width of screen divided by bytes moved
	add.w	#$15,a5		; number of bytes to move left right
	cmp.w	#220,a5		; is it the bottom of screen
	bge	waitleave	; yes its the end of screen
	bra	scrollscrn
