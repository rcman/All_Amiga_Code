...
credit1:	dc.b	'Our First Game Written entierly in 68000 ',0
		cnop	0,2
credit2:	dc.b	'Code. I would like to thank all the people ',0
		cnop	0,2
credit3:	dc.b	'who supported me and and kept me going. ',0
		cnop	0,2
credit4:	dc.b	'Sean Godsell and Kevin Hoare. Programming',0
		cnop	0,2
credit5:	dc.b	'Assembler  takes  a  lot  of  patience,  ',0
		cnop	0,2
credit6:	dc.b	'determination and a dream. My programming',0
		cnop	0,2
credit7:	dc.b	'will only get better as time goes on and',0
		cnop	0,2
credit8:	dc.b	'hopefully some really fantastic programs',0
		cnop	0,2
credit9:	dc.b	'will too.           Thanks  Franco Gaetan' ,0
		cnop	0,2
credit10:	dc.b	'             ' ,0
		cnop	0,2
