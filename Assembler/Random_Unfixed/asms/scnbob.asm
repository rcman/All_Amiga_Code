; This program loads a screen, lifts a block from the screen. MOve the object
; around the screen with the mouse. Like a BOB with no double buffering


; Written By: Sean Godsell, Franco Gaetan
; Date of Last Revision: May 25, 1991
; File SCNBOB.ASM
; Status: Working 
