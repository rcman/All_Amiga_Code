...
PlaceBob:
	...
	move.w	#36,bltcmod(a2)		;modulus for D destination
...
waitblit2:
	...
	move.w	#1,d4		;Shift Value
	move.w	d4,bltcon1(a2)		;Set to LF and registers to use
	or.w	#$0fca,d4
	move.w	d4,bltcon0(a2)		;Set to 0 for area mode

	move.w	#2,bltbmod(a2)		;modulus for A Source mask
	move.w	#2,bltamod(a2)		;modulus for B destination car
	move.l	MemArea,d0
...
car:
	...
	dc.l	%00000001111000000000011111000000
	dc.l	%00000000000000000000000000000000
	dc.l	%00000000000000000000000000000000
	dc.l	%00000000000000000000000000000000
	ds.l	30
