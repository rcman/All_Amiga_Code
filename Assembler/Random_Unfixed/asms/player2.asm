...
;**************************************************************************
 ...
 include 'assem:include/franco.i'
...
mod_name:      dc.b 'df1:demo/dss_tracker_demo',0
               cnop 0,2


SongPointer:    dc.l    0               ; address of Module in CHIP memory
